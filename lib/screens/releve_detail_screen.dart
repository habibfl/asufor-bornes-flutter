...
class _RelevelDetailScreenState extends State<RelevelDetailScreen> {
  ...
  double get _totalM3 =>
      _releves.fold(0.0, (s, r) => s + r.consommation());

  double get _totalFCFA =>
      _releves.fold(0.0, (s, r) => s + r.montantAPayer(_tarifM3));
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Cette action est irréversible.',
            style: TextStyle(color: kSublabel)),
        actions: [
          TextButton(
  ...
  void _modifier(int index) async {
    await Navigator.pushNamed(
      ...
      arguments: {
        ...
        'releves': _releves,
        'tarifM3': _tarifM3,
        'releveAModifier': _releves[index],
        'indexModifier': index,
      },
    );
    setState(() {});
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(color: Color(0x3D2BB5A0), blurRadius: 16, offset: Offset(0, 6))
          ],
        ),
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  _MiniStat(
                      label: 'Volume total',
                      value: '${_totalM3.toStringAsFixed(1)} m³'),
                  const SizedBox(width: 10),
                  _MiniStat(
                      label: 'Total FCFA',
                      value: '${_totalFCFA.toStringAsFixed(0)} F',
                      accent: true),
                  const SizedBox(width: 10),
          ...
          SliverPadding(
            ...
            sliver: _releves.isEmpty
                ? const SliverToBoxAdapter(
                    child: Center(
                      child: Padding(
                        ...
                        child: Text('Aucun relevé',
                            style: TextStyle(color: kSublabel, fontSize: 16)),
                      ),
                    ),
                  )
                : SliverList.separated(
                    ...
                    itemBuilder: (_, i) => _ReleveCard(
                      releve: _releves[i],
                      tarifM3: _tarifM3,
                      formatDate: _date,
                      onDelete: () => _supprimer(i),
                      onEdit: () => _modifier(i),
                    ),
                  ),
          ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(label,
                style: const TextStyle(
                    fontSize: 11, color: kSublabel, fontWeight: FontWeight.w500)),
            const SizedBox(height: 6),
            Text(value,
                style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w800,
                    color: accent ? kTeal : kLabel,
                    letterSpacing: -0.2),
                maxLines: 1,
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w800,
                      color: releve.paye ? kTeal : kOrange,
                      letterSpacing: 0.4),
                ),
              ),
            ],
          ...
          Row(
            ...
            children: [
              CupertinoButton(
                ...
                minSize: 32,
                onPressed: onEdit,
                child: const Icon(CupertinoIcons.pencil, color: kTeal, size: 18),
              ),
